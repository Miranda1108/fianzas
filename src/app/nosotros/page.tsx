    ...
    <>
      ...
      <div className="bg-gray-bg border-b border-gray-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <nav className="text-sm text-gray-muted flex items-center gap-2">
            ...
            <span>/</span>
            <span className="text-navy font-medium">Nosotros</span>
          </nav>
        </div>
      </div>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose max-w-none">
            <h2 className="font-[var(--font-heading)] text-2xl md:text-3xl font-bold text-navy mb-6">
              ¿Quiénes somos?
            </h2>
      ...
      <section className="py-16 md:py-20 bg-gray-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="font-[var(--font-heading)] text-2xl md:text-3xl font-bold text-navy mb-10 text-center">
            ¿Por qué elegirnos?
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {VALUES.map((val, i) => (
              <div key={i} className="bg-white rounded-2xl p-6 text-center border border-gray-100 shadow-sm hover:shadow-lg transition-shadow">
                <div className="w-16 h-16 mx-auto mb-4 bg-gray-bg rounded-2xl flex items-center justify-center text-brand">
                  {val.icon}
                </div>
                <h3 className="font-[var(--font-heading)] font-bold text-navy mb-2">{val.title}</h3>
                <p className="text-gray-muted text-sm">{val.desc}</p>
              </div>
            ))}
          </div>
        </div>
