      ...
      <div className="bg-gray-bg border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <nav className="text-sm text-gray-muted flex items-center gap-2">
            ...
            <span>/</span>
            <span className="text-navy font-medium">Aviso de Privacidad</span>
          </nav>
        </div>
      </div>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose max-w-none text-gray-text leading-relaxed space-y-6">
            ...
            <h2 className="font-[var(--font-heading)] text-xl font-bold text-navy mt-8">¿Para qué fines utilizamos sus datos personales?</h2>
            ...
            <h2 className="font-[var(--font-heading)] text-xl font-bold text-navy mt-8">¿Con quién compartimos su información?</h2>
            <p>
            ...
            <h2 className="font-[var(--font-heading)] text-xl font-bold text-navy mt-8">Derechos ARCO</h2>
            <p>
              Usted tiene derecho a conocer qué datos personales tenemos de usted, para qué los utilizamos y las condiciones del uso que les damos (Acceso). Asimismo, es su derecho solicitar la corrección de su información personal en caso de que esté desactualizada, sea inexacta o incompleta (Rectificación); que la eliminemos de nuestros registros o bases de datos cuando considere que la misma no está siendo utilizada adecuadamente (Cancelación); así como oponerse al uso de sus datos personales para fines específicos (Oposición).
            </p>
            <p>
              Para el ejercicio de cualquiera de los derechos ARCO, puede enviar un correo electrónico a <strong>hola@fianzify.mx</strong>.
            </p>
            ...
            <p className="text-gray-muted text-sm mt-8">
