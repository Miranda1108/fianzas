      ...
      <div className="bg-gray-bg border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <nav className="text-sm text-gray-muted flex items-center gap-2">
            ...
            <span>/</span>
            <span className="text-navy font-medium">Contacto</span>
          </nav>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="space-y-6">
              <div className="bg-gray-bg rounded-2xl p-6 border border-gray-100">
                <h3 className="font-[var(--font-heading)] font-bold text-navy mb-4">Información de contacto</h3>
                <ul className="space-y-4">
                  <li className="flex items-center gap-3">
                    <span className="w-10 h-10 bg-brand/10 rounded-xl flex items-center justify-center text-brand">
                  ...
                  <li className="flex items-center gap-3">
                    <span className="w-10 h-10 bg-whatsapp/10 rounded-xl flex items-center justify-center text-whatsapp">
              ...
              <div className="bg-gray-bg rounded-2xl p-6 border border-gray-100">
                <h3 className="font-[var(--font-heading)] font-bold text-navy mb-2">Horario de atención</h3>
                <p className="text-gray-muted text-sm">Lunes a Viernes: 9:00 - 18:00 hrs</p>
              </div>
            </div>

            {/* Form */}
            <div className="lg:col-span-2 bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
              <h2 className="font-[var(--font-heading)] text-2xl font-bold text-navy mb-6">
                Envíanos un mensaje
              </h2>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <input type="tel" required placeholder="Teléfono / WhatsApp" value={formData.telefono} onChange={(e) => setFormData({ ...formData, telefono: e.target.value })} className="w-full px-4 py-3.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-brand focus:border-transparent" />
                  <input type="email" placeholder="Email (opcional)" value={formData.email} onChange={(e) => setFormData({ ...formData, email: e.target.value })} className="w-full px-4 py-3.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-brand focus:border-transparent" />
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <p className="text-xs text-gray-muted text-center">
                  ...
                  <Link href="/aviso-privacidad" className="text-brand underline">Aviso de Privacidad</Link>.
                </p>
              </form>
            </div>
          </div>
