    ...
    <section id="documentos" className="bg-gray-bg py-16 md:py-24">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-10 reveal">
          <a
            href="/Fianzify_Checklist_Documentos_PersonaMoral.pdf"
            download
            className="inline-flex items-center justify-center gap-2 bg-navy hover:bg-navy-mid text-white font-[var(--font-heading)] font-semibold rounded-xl px-6 py-3.5 text-sm transition-all"
          >
