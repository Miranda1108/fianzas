    ...
    <section className="py-16 md:py-24 bg-gray-bg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          {/* Right: Cost card */}
          <div className="bg-white rounded-2xl shadow-md border border-gray-border p-8 lg:sticky lg:top-28">
            <h2 className="font-[var(--font-heading)] text-2xl md:text-3xl font-extrabold text-navy mb-2">
              ¿Cuánto cuesta<br />una fianza?
            </h2>
            <p className="text-gray-text text-base mb-6 leading-relaxed">
              El costo promedio en México va del{" "}
              <span className="font-bold text-brand">1% al 3%</span> del monto
              del contrato.
            </p>
            ...
            <ul className="space-y-3 mb-8">
              {[
                ...
                <li key={i} className="flex items-center gap-3">
                  <span className="w-6 h-6 bg-brand rounded-full flex items-center justify-center flex-shrink-0">
