...
const FIANZA_TYPES = [
  {
    ...
    title: "Anticipo",
    description:
      "Garantiza la correcta aplicación del anticipo entregado para iniciar una obra o servicio.",
    icon: (
  ...
  },
  {
    ...
    title: "Cumplimiento",
    description:
      "Garantiza el cumplimiento de las obligaciones de un contrato público o privado.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    title: "Sostenimiento de propuesta",
    description:
      "Respalda la seriedad de tu propuesta en una licitación o concurso.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    title: "Vicios ocultos / buena calidad",
    description:
      "Cubre defectos o vicios ocultos que aparezcan después de entregar la obra.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description:
      "Respalda obligaciones ante dependencias y entidades gubernamentales.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    title: "Judicial",
    description:
      "Garantía emitida por resolución de un juez para asegurar una obligación legal.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    title: "Arrendamiento",
    description:
      "Sustituye el depósito en garantía en contratos de renta de inmuebles.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    href: "/fianza-de-fidelidad",
    title: "Fidelidad",
    description:
      "Protege a tu empresa ante fraudes o daños causados por empleados de confianza.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
