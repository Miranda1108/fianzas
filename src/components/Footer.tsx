...
const SERVICES = [
  ...
  { href: "/fianza-vicios-ocultos", label: "Fianza de Vicios Ocultos" },
];
    ...
    <footer className="bg-primary text-white">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-6">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <div>
                <div className="font-[var(--font-heading)] font-bold text-lg leading-tight">GRUPO AFIANZADOR MX</div>
                <div className="text-xs text-white/60">Fianzas para Licitaciones y Contratos</div>
              </div>
            </Link>
            <p className="text-white/70 text-sm leading-relaxed">
              Especialistas en fianzas para proveedores de gobierno en CDMX y Estado de México. Evaluación sin costo.
            </p>
          </div>

          {/* Servicios */}
          <div>
            <h3 className="font-[var(--font-heading)] font-bold text-sm uppercase tracking-wider mb-4 text-accent">
              Servicios
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-2 text-sm text-white/70">
                <svg className="w-4 h-4 flex-shrink-0 text-cta" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <a
              href="https://wa.me/521XXXXXXXXXX?text=Hola%2C%20me%20interesa%20cotizar%20una%20fianza%20para%20mi%20contrato%20de%20gobierno.%20%C2%BFMe%20pueden%20apoyar%3F"
              target="_blank"
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col sm:flex-row justify-between items-center gap-2 text-xs text-white/50">
          <p>&copy; 2026 Grupo Afianzador MX. Todos los derechos reservados.</p>
