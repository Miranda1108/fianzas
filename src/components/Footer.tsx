    ...
    <footer className="bg-navy text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li>
                <Link href="/aviso-privacidad" className="text-sm text-white/70 hover:text-white transition-colors">
                  Aviso de privacidad
                </Link>
              </li>
              <li>
            ...
            <div className="mt-5">
              <p className="text-xs text-white/40 mb-2">Horario de atención</p>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col sm:flex-row justify-between items-center gap-2 text-xs text-white/50">
          <p>&copy; 2024 Fianzify. Todos los derechos reservados.</p>
          <div className="flex gap-3">
            <Link
              href="/aviso-legal"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-4">
          <p className="text-xs text-white/30 text-center">
            Fianzify es un intermediario que conecta a usuarios con afianzadoras
