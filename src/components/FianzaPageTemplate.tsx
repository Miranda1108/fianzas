      ...
      <div className="bg-gray-bg border-b border-gray-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <nav className="text-sm text-gray-muted flex items-center gap-2">
            ...
            <span>/</span>
            <Link href="/#tipos-fianzas" className="hover:text-brand transition-colors">Tipos de Fianzas</Link>
            <span>/</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <ul className="space-y-3">
                  {details.map((detail, i) => (
                    <li key={i} className="flex items-start gap-3">
                      <span className="w-6 h-6 bg-brand rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                        <svg className="w-4 h-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}>
                          <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                        </svg>
                      </span>
                      <span className="text-gray-text">{detail}</span>
                    </li>
                  ))}
                </ul>
              </div>
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-2xl shadow-md border border-gray-border p-6">
                <h3 className="font-[var(--font-heading)] font-bold text-lg text-navy mb-4">Resumen</h3>
                <div className="space-y-4">
                  <div className="flex justify-between border-b border-gray-border pb-3">
                    <span className="text-gray-muted text-sm">Cobertura</span>
                    <span className="text-navy font-semibold text-sm">{coverage}</span>
                  </div>
                  <div className="flex justify-between border-b border-gray-border pb-3">
                    <span className="text-gray-muted text-sm">Vigencia</span>
                    <span className="text-navy font-semibold text-sm">{duration}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-muted text-sm">Prima estimada</span>
                    <span className="text-brand font-bold text-sm">{costRange}</span>
                  </div>
                </div>
              </div>
